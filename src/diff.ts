import { OpenrpcDocument, MethodObject,  MethodOrReference, MethodObjectParams, ContentDescriptorOrReference, ContentDescriptorObject } from "@open-rpc/meta-schema";
import {
    MethodDoesNotExistErr,
    MethodParamStructureErr,
    DiffErrors,
    MethodMissingParam,
    MethodRequiredError, MethodSchemaError, ResultError
} from "./errors";
